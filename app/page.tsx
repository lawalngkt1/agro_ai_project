    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f8fdf9" }}>
      ...
      >
        ...
        >
          ...
          >
            AI-powered crop recommendation, soil analysis, and plant disease
            detection — all in one precision agriculture platform.
          </p>
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          >
            Each module is independently powered by domain-specific ML models
          ...
          >
            {whyItems.map((item) => (
              ...
              >
                ...
                <p style={{ fontSize: 14, color: "#5a7a63", lineHeight: 1.6 }}>
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      <section style={{ padding: "64px 24px" }}>
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              Join thousands of farmers leveraging AI-driven insights to grow
              smarter, reduce waste, and increase yield.
            </p>
            <div
              style={{
                display: "flex",
...
>
  ...
  >
    ...
    <div>
      ...
      <p style={{ fontSize: 13, color: "#6b8f74", marginTop: 12, lineHeight: 1.6 }}>
        AI-powered precision agriculture system for smarter farming decisions
        using machine learning and real-time data.
      </p>
    </div>
    ...
    <div>
      ...
      <p style={{ fontSize: 13, color: "#6b8f74", marginTop: 10, lineHeight: 1.6 }}>
        © {new Date().getFullYear()} AgroAI Advisor.  
