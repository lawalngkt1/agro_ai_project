  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fdf9' }}>
      ...
      <div style={{ paddingTop: 88, paddingBottom: 60 }}>
        ...
        <div
          style={{
            background: 'linear-gradient(160deg, #f0fdf4 0%, #d1fae5 60%, #f8fdf9 100%)',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              ...
              <div>
                ...
                <p style={{ color: '#4b7a59', fontSize: 14, margin: 0, marginTop: 4 }}>
                  Upload a photo of your plant to detect diseases with Vision AI.
                </p>
              </div>
            </div>
          </div>
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '36px 24px 0' }}>
          ...
          >
            <Info size={16} color="#15803d" style={{ marginTop: 1, flexShrink: 0 }} />
            <p style={{ fontSize: 13, color: '#1a4d2a', margin: 0, lineHeight: 1.5 }}>
              For best results, upload a clear, well-lit photo of the affected plant part (leaf, stem, or fruit). Supported formats: JPG, PNG, WEBP. Max size: 10MB.
            </p>
          </div>
          ...
          >
            <h2 style={{ fontSize: 16, fontWeight: 700, color: '#14532d', marginBottom: 20, marginTop: 0 }}>
              Upload Plant Image
            </h2>
            ...
            {!previewUrl ? (
              <div
                ...
                style={{
                  ...
                  textAlign: 'center',
                  cursor: 'pointer',
                  backgroundColor: dragOver ? 'rgba(22,163,74,0.05)' : 'rgba(240,253,244,0.6)',
              ...
              >
                ...
                <p style={{ fontSize: 16, fontWeight: 600, color: '#14532d', margin: '0 0 8px' }}>
                  {dragOver ? 'Drop your image here' : 'Click to upload or drag & drop'}
                </p>
                <p style={{ fontSize: 13, color: '#6b8f74', margin: 0 }}>JPG, PNG, WEBP — up to 10MB</p>
              </div>
            ) : (
              <div style={{ position: 'relative' }}>
                ...
                >
                  ...
                  <span style={{ fontSize: 13, color: '#2d6a3f', fontWeight: 500 }}>
          ...
          <button
            ...
            style={{
              ...
              justifyContent: 'center',
              gap: 10,
              boxShadow: loading || !selectedFile ? 'none' : '0 4px 20px rgba(21,128,61,0.3)',
              transition: 'all 0.2s ease',
            }}
          >
            {loading ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <h3 style={{ color: '#fff', fontSize: 20, fontWeight: 800, margin: '4px 0 0', letterSpacing: '-0.2px' }}>
                          {result.name}
                        </h3>
                    ...
                    <div style={{ padding: '20px 28px 24px' }}>
                      ...
                      {result.description && (
                        <p style={{ fontSize: 14, color: '#2d4a35', lineHeight: 1.65, marginBottom: 16 }}>
                          {result.description}
                        </p>
                      )}
                      ...
                      {result.treatment && (
                        ...
                        >
                          {result.type === 'healthy' ? (
                            <Leaf size={15} color={cfg.treatmentColor} style={{ marginTop: 1, flexShrink: 0 }} />
                          ) : (
                            <Shield size={15} color={cfg.treatmentColor} style={{ marginTop: 1, flexShrink: 0 }} />
                          )}
                          <div>
                            <p style={{ fontSize: 12, fontWeight: 700, color: cfg.treatmentColor, margin: '0 0 4px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                              {result.type === 'healthy' ? 'Care Tip' : 'Treatment'}
                            </p>
                            <p style={{ fontSize: 13, color: cfg.treatmentText, margin: 0, lineHeight: 1.55 }}>
                              {result.treatment}
                            </p>
                          </div>
                        </div>
